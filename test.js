...
app.post('/api/users/add', function(req, res) {
    ...
    var sql = 'INSERT INTO users (nickname, email, join_date, level, app_version, c_login_date, p_login_date) VALUES (?, ?, ?, ?, ?, ?, ?) WHERE NOT EXISTS (SELECT * FROM users WHERE email = VALUS (email))';
