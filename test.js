...
app.post('/api/users/add', function(req, res) {
    ...
    var sql = 'INSERT IGNORE INTO users (nickname, email, join_date, level, app_version, c_login_date, p_login_date) VALUES (?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE email = VALUES (email);';
